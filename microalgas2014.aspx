<%@ Page Language="C#" AutoEventWireup="true" CodeFile="microalgas2014.aspx.cs" Inherits="microalgas2014" %>
                    ...
                    <tr>
                        <td style="width:160px; text-align: center;">
                            <asp:Image ID="Image1" runat="server" 
                                Height="70px" ImageUrl="~/Images/logo-microalgas.png" /></td>
                        <td style="width:480px; text-align:center; font-size: 10pt; font-family: Arial; font-weight: bold;">
                            <asp:Label ID="lblTituloEvento" runat="server" Font-Bold="True" 
                                ...
                                Text="Curso Teórico Práctico de Ecofisiología y Biotecnología de Microalgas"></asp:Label>
                            <br />
                            <br />
                        ...
                        <td style="width:160px; text-align: center;">
                            <asp:Image ID="Image2" runat="server" Height="70px" 
                                ImageUrl="~/Images/logo-microalgaslab.png" />
                        </td>
                    </tr>
                </table>
                <br />
                ...
                <tr>
                    <td colspan="3" style="text-align: center;">
                        ...
                        <asp:Label ID="Label1" runat="server" Font-Bold="True" 
                            ...
                            Text="UNICAMENTE SE ACEPTAN PARTICIPANTES PARA EL CURSO TEORICO" 
