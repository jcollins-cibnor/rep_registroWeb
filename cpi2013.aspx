<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cpi2013.aspx.cs" Inherits="cpi2013" %>
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:DropDownList ID="ddlRegistro" runat="server" Font-Italic="True" 
                            Font-Names="Verdana" Font-Size="8pt" Width="160px" 
                            onselectedindexchanged="ddlRegistro_SelectedIndexChanged">
                            <asp:ListItem Selected="True" Value="--">Seleccione una opción...</asp:ListItem>
                            <asp:ListItem>Conferencista magistral</asp:ListItem>
                            <asp:ListItem>Ponente</asp:ListItem>
                            <asp:ListItem>Panelista</asp:ListItem>
            ...
            <table style="border:0; width:500pt; font-size: 8pt;">                        
                ...
                <tr>
                    <td style="text-align:left; font-size: 9pt;" colspan="2">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorEje" runat="server" 
                            ControlToValidate="rblEje" Enabled="False" Font-Bold="True" ForeColor="Red" 
                            InitialValue="--" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left; vertical-align: middle;">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
                            ControlToValidate="txtRegresoNoVuelo1" Font-Bold="True" ForeColor="Red" 
                            SetFocusOnError="True">*</asp:RequiredFieldValidator>
                        <br />
                ...
                <tr> 
                    ...
                    <td style="text-align: left;">
                        <asp:TextBox ID="txtHotel" runat="server" Font-Bold="False" Font-Names="Verdana" 
                            Font-Size="8pt" MaxLength="200" ReadOnly="True" Width="180pt">Fiesta Americana Condesa</asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
