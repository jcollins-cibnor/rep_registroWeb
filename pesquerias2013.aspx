<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pesquerias2013.aspx.cs" Inherits="pesquerias2013" %>
                ...
                <table style="font-family: Verdana; width:500pt;">
                    <tr>
                        <td style="width:160px; text-align: center;">
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/SMP_logo.jpg" 
                                Height="70px" /></td>
                        <td style="width:480px; text-align:center; font-size: 10pt; font-family: Arial; font-weight: bold;">
                            <asp:Label ID="lblTituloEvento" runat="server" Font-Bold="True" 
                                ...
                                Text="IV Reunión Bienal de la Sociedad Mexicana de Pesquerías"></asp:Label>
                            <br />
                            <br />
