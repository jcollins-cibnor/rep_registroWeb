...
public partial class cultivos2014 : System.Web.UI.Page
{
    ...
    {
        SqlDSregistro.InsertCommand = "INSERT INTO cultivos2014 VALUES ('" + 
            txtNombres.Text + "', '" + 
            txtApellidos.Text + "', '" + 
            txtCorreo.Text + "', '" + 
            txtInstitucion.Text + "', '" +
        ...
        try
        {
            Opb.enviarCorreo("cultivos@cibnor.mx", txtCorreo.Text, "cultivos@cibnor.mx", "Registro en Linea - Cultivos 2014", mensaje);
        }
        catch (Exception ex)
        {
        ...
        Response.Redirect("~/RegistroOk.aspx?evento=cultivos2014");
    }
}