<%@ Page Language="C#" AutoEventWireup="true" CodeFile="constanciasPosgrado2014.aspx.cs" Inherits="constanciasPosgrado2014" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>XIV Semana del Posgrado en BCS - Descarga de constancias</title>
...
<body>
    ...
    <div align="center">
        ...
        <asp:SqlDataSource ID="SqlDSconstancias" runat="server" 
            ...
            SelectCommand="SELECT * FROM [Posgrado2014constancias] ORDER BY [apellidos], [nombres]"></asp:SqlDataSource>
...
--%>
        ...
        <asp:GridView ID="GVconstancias" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="tipo" HeaderText="TIPO DE REGISTRO" 
                    SortExpression="tipo" />
