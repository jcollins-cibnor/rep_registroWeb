<%@ Page Language="C#" AutoEventWireup="true" CodeFile="constanciasOGMforo2014.aspx.cs" Inherits="constanciasOGMforo2014" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Foro OGMs 2014 - Descarga de constancias</title>
...
<body>
    ...
    <div align="center">
            ...
            <tr>
                <td style="width:160px; text-align: center;">
                    <asp:Image ID="Image1" runat="server" 
                        Height="50px" ImageUrl="~/Images/cibreg.png" /></td>
        ...
        <asp:SqlDataSource ID="SqlDSconstancias" runat="server" 
            ...
            SelectCommand="SELECT * FROM [ogmforo2014constancias]"></asp:SqlDataSource>
...
--%>
        ...
        <asp:GridView ID="GVconstancias" runat="server" AutoGenerateColumns="False" 
            ...
            GridLines="None" Font-Size="8pt" HorizontalAlign="Center" AllowSorting="True" 
                onselectedindexchanged="GVconstancias_SelectedIndexChanged">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="nombreconstancia" HeaderText="NOMBRE DE LA CONSTANCIA" 
                    SortExpression="nombreconstancia" />
            </Columns>
