<%@ Page Language="C#" AutoEventWireup="true" CodeFile="anivtaller.aspx.cs" Inherits="anivtaller" %>
            ...
            <tr>
                ...
                <td style="width:480px; text-align:center; font-size: 14pt; font-family: Arial; font-weight: bold;">
                    ...
                    <asp:Label ID="lblTituloRegistro" runat="server" Font-Bold="False" 
                                ...
                                Text="Registro en Linea - Taller de fondos CONACyT"></asp:Label>
                </td>
            </tr>
        </table>
...
<hr style="visibility:hidden;"/>
            <table style="border:0; width:500pt;  font-size: 8pt;">
                ...
                <tr>
                    <td style="text-align:right; font-family: Verdana">
                        <asp:Label ID="lblInstitucion" runat="server" Font-Bold="False" Font-Names="Verdana" 
                            Font-Size="8pt" Text="Institución:"></asp:Label>
                    </td>
                    <td style="text-align: left">
                        <asp:TextBox ID="txtInstitucion" runat="server" Font-Size="8pt" MaxLength="50" 
                            Width="240px" />
                    </td>
                    <td>
                        &nbsp;</td>
                ...
                <tr>
                    <td colspan="3" style="text-align:center;">
                        ...
                        <asp:SqlDataSource ID="SqlDSregistroWeb" runat="server" 
                            ...
                            DeleteCommand="DELETE FROM [Anivtaller] WHERE [id] = @original_id" 
                            InsertCommand="INSERT INTO [Anivtaller] ([nombres], [apellidos], [correo], [telefono], [institucion], [comentarios]) VALUES (@nombres, @apellidos, @correo, @telefono, @institucion, @comentarios)" 
                            SelectCommand="SELECT * FROM [Anivtaller]" 
                            
                            UpdateCommand="UPDATE [Anivtaller] SET [nombres] = @nombres, [apellidos] = @apellidos, [correo] = @correo, [telefono] = @telefono, [institucion] = @institucion, [comentarios] = @comentarios WHERE [id] = @original_id" 
