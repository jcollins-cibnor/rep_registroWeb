...
public partial class cpi2013 : System.Web.UI.Page
{
    ...
    protected void btnContinuar_Click(object sender, EventArgs e)
    {
        ...
        if (ddlRegistro.SelectedValue == "Staff")
        { 
            rblEje.SelectedIndex = 7;
        }
    ...
    {
        SqlDScongresocpi2013.InsertCommand = "INSERT INTO CPI2013 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtTelefono.Text +
            "', '" + txtInstitucion.Text +
        ...
        Response.Redirect("~/RegistroOk.aspx?evento=cpi2013");
    }
    ...
    protected void ddlRegistro_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlRegistro.SelectedValue != "Staff")
        {
            RequiredFieldValidatorEje.Enabled = true;
        }
        else
        {
            RequiredFieldValidatorEje.Enabled = false;
        }
    }
}