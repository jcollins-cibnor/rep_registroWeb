...
public partial class anivpaseo : System.Web.UI.Page
{
    ...
    protected void btnContinuar_Click(object sender, EventArgs e)
    {
        ...
        "Club o institución ..: " + txtClub.Text + '\n' +
        '\n' +
        '\n' +
    ...
    protected void btnEnviar_Click(object sender, EventArgs e)
    {
        ...
        SqlDSregistroWeb.InsertCommand = "INSERT INTO Anivpaseo VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtTelefono.Text +
            "', '" + txtEdad.Text +
        ...
        string mensaje = "Estimado(a) " + txtNombres.Text + ", usted ha sido registrado en el Paseo en Bicicleta" + '\n' +
            '\n' +
            Session["mensajeConfirmacion"] +
            "Gracias," + '\n' + "Comite Organizador" + '\n' + "CIBNOR, S.C.";
        ...
        enviarCorreo("eventos@cibnor.mx", "ecortes04@cibnor.mx", "-", "CIBNOR, " + lblTituloRegistro.Text, mensaje);

        Response.Redirect("~/RegistroOk.aspx?evento=anivpaseo");
    }
