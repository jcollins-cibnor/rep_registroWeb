<%@ Page Language="C#" AutoEventWireup="true" CodeFile="microscopia2014.aspx.cs" Inherits="microscopia2014" %>
            ...
            <table style="border:0; width:600pt">
                ...
                <tr>
                    ...
                    <td style="text-align:left">
                        <asp:TextBox ID="txtNombres" runat="server" AutoCompleteType="Disabled" 
                            Width="240px" MaxLength="50" />
                ...
                <tr>
                    <td style="text-align:right; font-size: 9pt; font-family: Verdana">
                        Apellido(s):</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="txtApellidos" runat="server" Width="240px" MaxLength="50" />
                    </td>
                    <td> </td>
                </tr>
                <tr>
                    ...
                    <td style="text-align:left">
                        <asp:TextBox ID="txtCorreo" runat="server" AutoCompleteType="Disabled" 
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:TextBox ID="txtInstitucion" runat="server" Width="240px" MaxLength="200" />
                    </td>
                    <td>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:right; font-size: 9pt; font-family: Verdana">
                        Domicilio:</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="txtDomicilio" runat="server" Width="240px" MaxLength="200" />
                    </td>
                    <td> </td>
                </tr>
                <tr>
                    <td style="text-align:right; font-size: 9pt; font-family: Verdana">
                        Ciudad:</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="txtCiudad" runat="server" Width="240px" MaxLength="50" />
                    </td>
                    <td> </td>
                </tr>
                <tr>
                    <td style="text-align:right; font-size: 9pt; font-family: Verdana">
                        Estado:</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="txtEstado" runat="server" Width="240px" MaxLength="50" />
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
                <tr>
                    <td style="text-align:right; font-size: 9pt; font-family: Verdana">
                        País:</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="txtPais" runat="server" Width="240px" MaxLength="50" >México</asp:TextBox>
                    </td>
                    <td> </td>
                </tr>
                <tr>
            ...
            <table style="border:0; width:600pt">
                ...
                <tr>
                    ...
                    <td style="text-align: left; font-size: 9pt; font-family: Verdana">
                        <asp:TextBox ID="txtHotel" runat="server" Width="360px" MaxLength="50" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
