<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cultivos2014.aspx.cs" Inherits="cultivos2014" %>
                    ...
                    <tr>
                        <td style="width:160px; text-align: center;">
                            <asp:Image ID="Image1" runat="server" 
                                Height="50px" ImageUrl="~/Images/ciboficial.gif" /></td>
                        <td style="width:480px; text-align:center; font-size: 10pt; font-family: Arial; font-weight: bold;">
                            <asp:Label ID="lblTituloEvento" runat="server" Font-Bold="True" 
                                ...
                                Text="Cultivos de Apoyo para Uso en Acuicultura y Biotecnología"></asp:Label>
                            <br />
                            <br />
                ...
                <tr>
                    <td colspan="3" style="text-align: center">
                        ...
                        <asp:SqlDataSource ID="SqlDSregistro" runat="server" 
                            ...
                            DeleteCommand="DELETE FROM [cultivos2014] WHERE [id] = @original_id" 
                            InsertCommand="INSERT INTO [cultivos2014] ([nombres], [apellidos], [correo], [institucion], [comentarios]) VALUES (@nombres, @apellidos, @correo, @institucion, @comentarios)" 
                            SelectCommand="SELECT * FROM [cultivos2014]" 
                            
                            UpdateCommand="UPDATE [cultivos2014] SET [nombres] = @nombres, [apellidos] = @apellidos, [correo] = @correo, [institucion] = @institucion, [comentarios] = @comentarios WHERE [id] = @original_id" 
