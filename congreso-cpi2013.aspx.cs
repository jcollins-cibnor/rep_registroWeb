...
public partial class congreso_cpi2013 : System.Web.UI.Page
{
    ...
    {
        SqlDScongresocpi2013.InsertCommand = "INSERT INTO CongresoCPI2013 VALUES ('" + txtNombres.Text +
            "', '" + txtApellidos.Text +
            "', '" + txtCorreo.Text +
            "', '" + txtTelefono.Text +
            "', '" + txtInstitucion.Text +
        ...
        enviarCorreo("congreso-cpi2013@cibnor.mx", txtCorreo.Text, "congreso-cpi2013@cibnor.mx", "Registro en Linea - Congreso CPIs 2013", mensaje);

        Response.Redirect("~/RegistroOk.aspx?evento=congreso-cpi2013");
    }
