<%@ Page Language="C#" AutoEventWireup="true" CodeFile="anivindividual.aspx.cs" Inherits="anivindividual" %>
                        ...
                        <tr>
                            ...
                            <td style="text-align:left; width:25%;">
                                <asp:CheckBox ID="chkPingPong" runat="server" Font-Bold="False" 
                                    Font-Names="Verdana" Font-Size="8pt" Text="Ping Pong" Visible="False" />
                            </td>
                        </tr>
                    </table>
<hr style="visibility:hidden;"/>
