<%@ Page Language="C#" AutoEventWireup="true" CodeFile="expociencias2014.aspx.cs" Inherits="expociencias2014" %>
                        ...
                        <tr>
                            <td colspan="3" style="text-align: left;">
                                <asp:Label ID="lblDatosGenerales" runat="server" Font-Bold="True" Font-Names="Verdana" 
                                    Font-Size="9pt" Text=" DATOS GENERALES DE AUTOR(ES) Y ASESOR(ES)"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <asp:DropDownList ID="ddlArea" runat="server" Font-Names="Verdana" 
                                    ...
                                    <asp:ListItem Value="L">Desarrollo Emprendedor</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            <td style="text-align:left;">
                                <asp:Label ID="lblDescripcion" runat="server" Font-Bold="False" 
                                    Font-Names="Verdana" Font-Size="8pt" 
                                    Text="Escribe una descripción del proyecto donde se explique de forma general: objetivos, desarrollo e impacto social."></asp:Label>
                                &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" 
                                    ControlToValidate="txtDescripcionProyecto" Font-Bold="True" ForeColor="Red" 
                        ...
                        <tr>
                            <td style="text-align:left;">
                                <asp:Label ID="Label4" runat="server" Font-Bold="False" 
                                    Font-Names="Verdana" Font-Size="8pt" 
                                    Text="Autores del proyecto registrado en este formulario al igual que los Asesores; Aceptan las condiciones de participación que declara el evento de Expociencias Sudcaliforniana 2014 donde se estipula lo siguiente:"></asp:Label>
                                <p style=" font-family:Arial; font-size:9pt;">
                                "El fraude científico y la mala conducta, no son toleradas en ningún nivel de investigación o participación. El plagio, uso o presentación de trabajos de otra persona como propios, fabricación o falsificación de datos no serán aceptados. Proyectos fraudulentos no calificarán para participar en cualquier evento afiliado a Expociencias Sudcaliforniana 2014 independientemente de la etapa que se encuentren."
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td style="font-family: Verdana; text-align: center;">
                                <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Names="Verdana" 
                                    Font-Size="8pt"
                                    Text="Al presionar el botón Continuar, Alumnos y Asesores, ACEPTAMOS LAS CONDICIONES DE PARTICIPACIÓN."></asp:Label>
                            </td>
                        </tr>                        
                    </table>
            ...
            <asp:Panel ID="pnlConfirmacion" runat="server" Visible="False">
                <table style="border: 0; width: 600; font-size: 8pt">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:Label ID="lblConfirmacion" runat="server" Font-Names="Verdana" Font-Size="8pt"
